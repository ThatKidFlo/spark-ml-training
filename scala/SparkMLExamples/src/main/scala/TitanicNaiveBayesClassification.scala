...
/**
  * Created by alexsisu on 23/12/15.
  */
object TitanicNaiveBayesClassification extends App {
  val sparkConf = new SparkConf()
  sparkConf.setAppName("NaiveBayesExample")
  ...
  //TRAINING
  val model: NaiveBayesModel = NaiveBayes.train(trainingData)
